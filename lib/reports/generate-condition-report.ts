...
export async function generateConditionReport({
  tenancyId,
  sessionType,
  documentType,
  title,
  ...
  documentType: 'entry_report' | 'exit_report'
  title: string
}) {
  ...
  if (sessionError || !session) {
    return { error: `No completed ${sessionType} capture session found for this tenancy` }
  }
