export default function PrivacyPage() {
  return (
    <main className="mx-auto flex min-h-screen max-w-2xl flex-col gap-4 p-6 text-sm text-gray-800">
      ...
      <h2 className="text-lg font-semibold text-black">1. What we collect</h2>
      ...
      <h2 className="text-lg font-semibold text-black">2. Why we collect it</h2>
      <p>
      ...
      <h2 className="text-lg font-semibold text-black">3. Where it&apos;s stored</h2>
      <p>
      ...
      <h2 className="text-lg font-semibold text-black">4. Third parties</h2>
      ...
      <h2 className="text-lg font-semibold text-black">5. Retention</h2>
      <p>
      ...
      <h2 className="text-lg font-semibold text-black">7. Security</h2>
      <p>
