export default function TermsPage() {
  return (
    <main className="mx-auto flex min-h-screen max-w-2xl flex-col gap-4 p-6 text-sm text-foreground">
      ...
      <p>
        BondShield (&quot;we&quot;, &quot;us&quot;) provides a document preparation
      ...
      <h2 className="text-lg font-semibold text-foreground">1. What BondShield is — and isn&apos;t</h2>
      <p>
        BondShield helps you document your rental property&apos;s condition,
      ...
      <p>
        <strong>BondShield is not a law firm and does not provide legal advice.</strong>{' '}
      ...
      <p>
        To the maximum extent permitted by law, BondShield is provided
