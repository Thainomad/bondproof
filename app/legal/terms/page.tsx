export default function TermsPage() {
  return (
    <main className="mx-auto flex min-h-screen max-w-2xl flex-col gap-4 p-6 text-sm text-foreground">
      ...
      <p>
        StayProof (&quot;we&quot;, &quot;us&quot;) provides a document preparation
      ...
      <h2 className="text-lg font-semibold text-foreground">1. What StayProof is — and isn&apos;t</h2>
      <p>
        StayProof helps you document your rental property&apos;s condition,
      ...
      <p>
        <strong>StayProof is not a law firm and does not provide legal advice.</strong>{' '}
      ...
      <p>
        To the maximum extent permitted by law, StayProof is provided
